...
export const MealPreviewPage: React.FC<{
  ...
  return (
    <main className="fixed inset-0 z-[80] overflow-hidden bg-[#10271E] text-white">
      ...
      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#03120C]/95 via-[#03120C]/65 to-transparent px-4 pb-[max(5rem,env(safe-area-inset-bottom))] pt-28">
        <motion.section initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .14, ease: "easeOut" }} className="mx-auto max-w-lg rounded-[1.5rem] border border-white/20 bg-white/15 p-4 shadow-[0_16px_44px_rgba(0,0,0,.25)] backdrop-blur-2xl">
