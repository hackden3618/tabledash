                            ...
                            >
                                ...
                                <div className="flex justify-between items-center flex-wrap gap-2 border-t border-[#F3F4F6] pt-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {/* TODO - have a confirmation modal for excess paid amounts and inform the user that the business will owe the user KES ${amount.excess} */}
                                        {/* TODO - when an order is cancelled, and it was partially or fully paid, a customer's account should not be owed the cancelled amount... so if there was a paid amount in the account in the admin view, it should show a refund option and the wallet should acknowledge refund pending for the cancelled paid amount */}
                                        {item.paymentOutstanding && (
