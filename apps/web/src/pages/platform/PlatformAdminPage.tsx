                                ...
                                <div>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: s(3) }}>
                                        ...
                                        <div>
                                            ...
                                            <button type="button" className="platform-action secondary add-region-action" onClick={() => setShowRegionForm((open) => !open)} style={{ marginTop: s(3), background: "transparent", border: "none", color: T.primary, fontWeight: 700, cursor: "pointer", padding: 0 }}>{showRegionForm ? "Cancel new region" : "+ Add a new region"}</button>
                                            {showRegionForm && <div className="platform-inline-setup" style={{ marginTop: s(3), padding: s(3), border: `1px solid ${T.border}`, borderRadius: T.radius, display: "flex", flexDirection: "column", gap: s(2) }}>
